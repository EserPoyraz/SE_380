...
class _BmiPageState extends State<BmiPage> {
  ...
  Future<void> _calculate() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'BMI saved: ${bmi.toStringAsFixed(1)}',
          ),
        ),
      );
    }
  ...
  String _genderComment() {
    ...
    if (_gender == 'Male') {
      return
          'Note: Men may have a higher muscle mass. Waist circumference and muscle composition should also be considered.';
    } else {
      return
          'Note: Fat distribution differs in women. Waist-to-hip ratio and body fat percentage provide better insight.';
    }
  }
              ...
              AppCard(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      "Disclaimer: BMI alone does not fully represent body composition.",
                      textAlign: TextAlign.center,
